...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="?act=donhang">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form class="form" method="POST" enctype="multipart/form-data">
                    ...
                    <input name="name" class="input-style" value="<?= $result->name ?>" type="text">
                    <textarea name="mota"><?= htmlspecialchars($result->mota)?></textarea>
                    <input name="gia" class="input-style" value="<?= $result->gia ?>" type="textarea">
                    <input name="soluong" class="input-style" value="<?= $result->soluong?>" type="text">
                    <span>
